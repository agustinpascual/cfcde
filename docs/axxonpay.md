...
Testes locais: `node --test scripts/axxonpay.test.mjs scripts/axxonpay-fluxo.test.mjs`. Build: `npm run build`. Os testes simulam banco/gateway; não substituem transações de homologação na AxxonPay.
