...
export default function Page() {
  return (
    <PaginaInstitucional titulo="Trocas e devoluções" subtitulo="Saiba como pedir atendimento para um item recebido.">
      ...
      <a className={s.button} href="https://wa.me/554732249292?text=Ol%C3%A1%2C%20preciso%20de%20ajuda%20com%20uma%20troca%20ou%20devolu%C3%A7%C3%A3o." target="_blank" rel="noopener noreferrer">Solicitar atendimento</a>
    </PaginaInstitucional>
  );
}
