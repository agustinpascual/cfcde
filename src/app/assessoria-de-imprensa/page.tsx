...
export default function Page() {
  return (
    <PaginaInstitucional titulo="Assessoria de imprensa" subtitulo="Canal para entrevistas, informações institucionais e solicitações de imprensa.">
      ...
      <a className={s.button} href="https://wa.me/554732249292?text=Ol%C3%A1%2C%20tenho%20uma%20solicita%C3%A7%C3%A3o%20de%20imprensa%20sobre%20o%20Caf%C3%A9%20com%20Deus%20Pai." target="_blank" rel="noopener noreferrer">Falar com o atendimento</a>
    </PaginaInstitucional>
  );
}
