...
export default function Page() {
  return (
    <PaginaInstitucional titulo="Compras em atacado" subtitulo="Consulte disponibilidade e condições para compras em quantidade.">
      ...
      <a className={s.button} href="https://wa.me/554732249292?text=Ol%C3%A1%2C%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20compras%20em%20atacado." target="_blank" rel="noopener noreferrer">Consultar atendimento</a>
    </PaginaInstitucional>
  );
}
