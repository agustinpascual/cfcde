...
export default function HomeStore() {
  ...
  const cart = useCart();
  return <div data-cdp-home><ScrollReveal /><HomeHero cartCount={cart.quantity} onCartClick={() => setCartOpen(true)} /><main><HomeCommerce /><HomeLower /></main><CartDrawer open={cartOpen} onClose={() => setCartOpen(false)} cart={cart} /></div>;
}
